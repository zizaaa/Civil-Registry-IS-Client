...
function EditDeathCert() {
    ...
    const mutation = useMutation({
        mutationFn: async(formData:DeathCertData)=>{
            const { data } = await axios.post(`${serverURL}/api/cris/death-certificate/update/${id}`,{formData},{ withCredentials:true });
    ...
    const handleUpdate = () =>{
        mutation.mutate(deathCertCredentials);
    }

    useEffect(()=>{
        if (!isLoading && data) {
            for (const [dataKey, dataValue] of Object.entries(data)) {
                setDeathCertCredentials((prev) => ({
                    ...prev,
                                ...
                                <div className="flex flex-row gap-5">
                                    <div className="flex flex-row-reverse items-center gap-2">
                                        ...
                                        <input 
                                            ...
                                            value="single" 
                                            className="cursor-pointer" 
                                            defaultChecked={data.nine_civilStatus === 'SINGLE'}
                                    ...
                                    <div className="flex flex-row-reverse items-center gap-2">
                                        ...
                                        <input 
                                            ...
                                            value="married" 
                                            className="cursor-pointer" 
                                            defaultChecked={data.nine_civilStatus === 'MARRIED'}
                                            onChange={(e)=>{handleCivilStatusChange(e)}}
                                        />
                                    </div>
                                    <div className="flex flex-row-reverse items-center gap-2">
                                        ...
                                        <input 
                                            ...
                                            name="civil_status" 
                                            value="widowed" 
                                            defaultChecked={data.nine_civilStatus === 'WIDOWED'}
                                            className="cursor-pointer" 
                                            onChange={(e)=>{handleCivilStatusChange(e)}}
                                        />
                                    </div>
                                    <div className="flex flex-row-reverse items-center gap-2">
                                        ...
                                        <input 
                                            ...
                                            name="civil_status" 
                                            value="others" 
                                            defaultChecked={data.nine_civilStatus === 'OTHERS'}
                                            className="cursor-pointer" 
                                            onChange={(e)=>{handleCivilStatusChange(e)}}
                                        />
                                    </div>
                                    <div className="flex flex-row-reverse items-center gap-2">
                                        ...
                                        <input 
                                            ...
                                            name="civil_status" 
                                            value="unknown" 
                                            defaultChecked={data.nine_civilStatus === 'UNKNOWN'}
                                            className="cursor-pointer" 
                                            onChange={(e)=>{handleCivilStatusChange(e)}}
                                        />
                                    </div>
                                        ...
                                        <div className="flex flex-col gap-2">
                                            <div className="flex flex-row-reverse items-center justify-end gap-2">
                                                ...
                                                <input 
                                                    ...
                                                    className="cursor-pointer" 
                                                    defaultChecked={data.nineTeen_Attendant === 'PRIVATE PHYSICIAN'}
                                            ...
                                            <div className="flex flex-row-reverse items-center justify-end gap-2">
                                                ...
                                                <input 
                                                    ...
                                                    defaultChecked={data.nineTeen_Attendant === 'PUBLIC HEALTH OFFICER'} 
                                                    className="cursor-pointer" 
                                                    onChange={(e)=>{handleAttendant(e)}}
                                                />
                                            </div>
                                            <div className="flex flex-row-reverse items-center justify-end gap-2">
                                                ...
                                                <input 
                                                    ...
                                                    className="cursor-pointer" 
                                                    defaultChecked={data.nineTeen_Attendant === 'HOSPITAL AUTHORITY'}
                                                    onChange={(e)=>{handleAttendant(e)}}
                                                />
                                            </div>
                                        </div>
                                        <div className="flex flex-col gap-2">
                                            <div className="flex flex-row-reverse items-center justify-end gap-2">
                                                ...
                                                <input 
                                                    ...
                                                    name="attendant" 
                                                    value="None" 
                                                    defaultChecked={data.nineTeen_Attendant === 'NONE'}
                                                    className="cursor-pointer" 
                                                    onChange={(e)=>{handleAttendant(e)}}
                                                />
                                            </div>
                                            <div className="flex flex-row-reverse items-center justify-end gap-2">
                                                ...
                                                <input 
                                                    ...
                                                    value="others" 
                                                    className="cursor-pointer" 
                                                    defaultChecked={data.nineTeen_Attendant === 'OTHERS'}
                                                    onChange={(e)=>{handleAttendant(e)}}
                                                />
                                            </div>
                                        </div>
                                    ...
                                    <div className="ps-5">
                                        <div className="flex flex-row-reverse items-center justify-end gap-2">
                                            ...
                                            <input 
                                                ...
                                                name="autopsy" 
                                                value="Yes" 
                                                defaultChecked={data.twentyThree_Autopsy === 'YES'}
                                                className="cursor-pointer" 
                                        ...
                                        <div className="flex flex-row-reverse items-center justify-end gap-2">
                                            ...
                                            <input 
                                                ...
                                                name="autopsy" 
                                                value="No" 
                                                defaultChecked={data.twentyThree_Autopsy === 'NO'}
                                                className="cursor-pointer" 
                                                onChange={(e)=>{handleTwentyThreehangeEvent(e)}}
                                            />
                                        </div>
