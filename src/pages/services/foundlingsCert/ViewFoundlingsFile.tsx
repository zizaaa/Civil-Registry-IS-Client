...
function ViewFoundlingsFile() {
    ...
    const handlePrint = () =>{
        ...
        activityMutation.mutate(`Foundlings certificate printed for ${data?.one_name} (Registry No. ${data?.registryNumber})`);
    }
...
export default ViewFoundlingsFile