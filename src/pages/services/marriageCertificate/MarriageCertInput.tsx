                        ...
                        <div className="flex flex-row">
                            <div className="flex flex-col items-center flex-1">
                                ...
                                <input 
                                    ...
                                    onChange={(e)=>{setScannedFileData(prev => ({...prev, one_first_wife:e.target.value}))}}
                                />
                            </div>
                            <div className="flex flex-col items-center flex-1">
                                <label htmlFor="middle" className="text-gray-800 text-sm">
                                ...
                                <input 
                                    ...
                                    onChange={(e)=>{setScannedFileData(prev => ({...prev, one_middle_wife:e.target.value}))}}
                                />
                            </div>
                            <div className="flex flex-col items-center flex-1">
                                <label htmlFor="last" className="text-gray-800 text-sm">
                                ...
                                <input 
                                    ...
                                    onChange={(e)=>{setScannedFileData(prev => ({...prev, one_last_wife:e.target.value}))}}
                                />
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="flex flex-row">
                            <div className="flex flex-col flex-1 justify-between gap-2">
                                ...
                                <input 
                                    ...
                                    onChange={(e)=>{setScannedFileData(prev =>({...prev, fifteen_Office:e.target.value}))}}
                                />
                            </div>
                            <div className="flex flex-col flex-1 justify-between">
                                ...
                                <input 
                                    ...
                                    onChange={(e)=>{setScannedFileData(prev =>({...prev, fifteen_CityOrMunicipality:e.target.value}))}}
                                />
                            </div>
                            <div className="flex flex-col justify-between flex-1">
                                ...
                                <input 
                                    ...
                                    onChange={(e)=>{setScannedFileData(prev =>({...prev, fifteen_Province:e.target.value}))}}
                                />
                            </div>
                        </div>
                    </div>
