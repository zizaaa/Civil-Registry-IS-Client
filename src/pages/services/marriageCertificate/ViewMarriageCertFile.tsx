...
function ViewMarriageCertFile() {
    ...
    const handlePrint = () =>{
        ...
        activityMutation.mutate(`Marriage certificate printed for ${data?.one_first} (Registry No. ${data?.RegistryNumber})`);
    }
...
export default ViewMarriageCertFile